...
const zh = {
  ...
  exportSession: '导出会话',
  exportTitle: '导出会话',
  exportBody: '是否导出当前会话的所有内容？也可以只导出非前缀部分，其中不含系统提示词与会话开头。',
  exportAll: '导出全部内容（包含系统前缀）',
  exportDialogue: '导出非前缀部分',
...
const en: typeof zh = {
  ...
  exportBody: 'Export everything in the current session? The other option leaves out the prefix: no system prompt and no session head.',
  exportAll: 'Export everything (system prefix included)',
  exportDialogue: 'Export without the prefix',
