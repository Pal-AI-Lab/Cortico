...
const zh = {
  pageTitle: '模型提供商', navLabel: '模型提供商', navGroup: 'Core', create: '+ 新建供应商', newName: '新建供应商',
  ...
  nameHint: '1–64 位英文字母、数字、- 或 _，以字母或数字开头，不允许空格或系统保留名。',
  fixedModule: '供应商类型保存后不可更改。如需使用其他类型，请新建或复制一个供应商。',
  ...
  advancedHint: '一般无需修改。仅在使用自定义 API 网关或兼容服务时调整。', secret: '密钥环境变量名',
  extraHeaders: '附加请求头（JSON object）', extraBody: '附加请求体（JSON object）', priceRules: '完整计价规则（JSON array）',
  priceHint: '留空使用模块价目；没有适用价目时只记录 token。',
...
const en: typeof zh = {
  ...
  nameHint: '1–64 English letters, digits, - or _; start with a letter or digit. No spaces or reserved system names.',
  fixedModule: 'The connection type cannot change after saving. Create or duplicate a connection to use another type.',
  ...
  advancedHint: 'Usually no changes are needed. Adjust only for custom API gateways or compatible services.', secret: 'Credential environment variable',
  extraHeaders: 'Extra headers (JSON object)', extraBody: 'Extra request body (JSON object)', priceRules: 'Full pricing rules (JSON array)',
  priceHint: 'Leave blank for module pricing. Without applicable prices, only tokens are recorded.',
