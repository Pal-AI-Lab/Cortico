...
const zh = {
  ...
  keySet: '已配置；留空保留现有密钥', keyEmpty: '输入 API Key', fetchModels: '获取模型列表', catalogNoWindow: '目录没有给出这个模型的上下文上限；请按服务商文档手填。',
...
const en: typeof zh = {
  ...
  keySet: 'Configured; leave blank to keep the current key', keyEmpty: 'Enter API Key', fetchModels: 'Fetch model list', catalogNoWindow: 'The model list states no context window for this model; fill it in from the provider\'s documentation.',
